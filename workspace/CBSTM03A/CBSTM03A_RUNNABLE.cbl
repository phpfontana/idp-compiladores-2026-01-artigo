      ...
      *****************************************************************
           DISPLAY 'Running JCL : CARDDEMO  Step STATMNT '.
           DISPLAY 'DD Names from TIOT:'.
           DISPLAY ': TRNXFILE  -- null UCB'.
           DISPLAY ': XREFFILE  -- null UCB'.
           DISPLAY ': CUSTFILE  -- null UCB'.
           DISPLAY ': ACCTFILE  -- null UCB'.
           DISPLAY ': STMTFILE  -- null UCB'.
           DISPLAY ': HTMLFILE  -- null UCB'.
